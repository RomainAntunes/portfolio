...
export class NavbarComponent {
    ...
    },
    {
      ...
      callback: () =>
        this.messageService.add({
          ...
          smallContent:
            "* The english version can contain some mistakes, I'm not a native english speaker",
          buttons: [
            {
              text: 'English',
              link: '/assets/pdf/CV_Romain_Antunes_EN.pdf',
              callback: () =>
                window.open('/assets/pdf/CV_Romain_Antunes_EN.pdf', '_blank'),
            },
            {
              text: 'French',
              link: '/assets/pdf/CV_Romain_Antunes_FR.pdf',
              callback: () =>
                window.open('/assets/pdf/CV_Romain_Antunes_FR.pdf', '_blank'),
            },
          ],
        }),
  ...
  socialItems: SocialItem[] = [
    ...
    },
    {
      icon: 'ionCodeSlash',
      route:
        'https://codingame.com/profile/defc3ee5279aecc1bb6114e1f994ea9b3325423',
    },
    {
      icon: 'ionMailOutline',
